...
import kundenverwaltung.auth.AuthController;
...
public class ProjectController implements Serializable {
    ...
    private List<ProjectNode> flatTree;
    ...
    private void reload() {
        ...
        flatTree     = ProjectNode.flatten(rootProjects);
    }
    ...
    public List<ProjectNode> getFlatTree()              { return flatTree; }
